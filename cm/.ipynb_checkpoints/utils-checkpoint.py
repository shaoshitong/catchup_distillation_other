...
def check_ckpt(ckpt_path):
    ...
    generator_list = ckpt["generator_list"]
    ckpt_1, ckpt_2 = generator_list[0],generator_list[1]
    keys = ckpt_1.keys()
    for key in keys:
        param_2 = ckpt_2[key]
        param_1 = ckpt_1[key]
        loss = ((param_2-param_1)**2).mean()
        print(loss)
if __name__=="__main__":
    ...
    check_ckpt("/home/project/fast-ode/runs/cifar10-onlineslim-predstep-3-uniform-shakedrop0.75-beta20/training_state_latest.pth")